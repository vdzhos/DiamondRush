...
//        level1[38][14] = new Cell(new Floor(),null,null);
    ...
    private void initLevel3(){
        ...
        int[] additionalSegmentCheck1 = {12,16,14,19};
        Checkpoint check1 = new Checkpoint(3,8,11,21,additionalSegmentCheck1,3,25,4,4);
        int[] additionalSegmentCheck2 = {12,8,14,8};
        Checkpoint check2 = new Checkpoint(6,1,18,7,additionalSegmentCheck2,9,15,4,4);
        Checkpoint check3 = new Checkpoint(18,3,24,13,18,6,15,4);
        int[] additionalSegmentCheck4 = {9,16,10,16};
        Checkpoint check4 = new Checkpoint(11,11,18,19,additionalSegmentCheck4,5,7,4,4);
        int[] additionalSegmentCheck5 = {35,4,38,14};
        Checkpoint check5 = new Checkpoint(25,4,34,7,additionalSegmentCheck5,17,7,4,4);
        int[] additionalSegmentCheck6 = {35,4,38,14};
        Checkpoint check6 = new Checkpoint(25,4,34,7,additionalSegmentCheck5,27,7,4,4);
        int[] additionalSegmentCheck7 = {35,4,38,14};
        Checkpoint check7 = new Checkpoint(25,4,34,7,additionalSegmentCheck5,27,13,4,4);
        int[] additionalSegmentCheck8 = {35,4,38,14};
        Checkpoint check8 = new Checkpoint(25,4,34,7,additionalSegmentCheck5,17,17,4,4);
        int[] additionalSegmentCheck9 = {35,4,38,14};
        Checkpoint check9 = new Checkpoint(25,4,34,7,additionalSegmentCheck5,25,26,4,4);

        //Floor + (Harmless/Trap)
        Cell[][] level3 = new Cell[40][30];
        ...
        level3[6][12] = new Cell(new Floor(),new Chest(null, null, null, null, null),null);
        ...
        level3[6][19] = new Cell(new Floor(),new Tumbleweed(),null);
        ...
        level3[7][18] = new Cell(new Floor(),null,fireTrap1);//new Diamond()
        level3[7][19] = new Cell(new Floor(),new Tumbleweed(),null);
        ...
        level3[8][7] = new Cell(new Floor(),null,null);
        ...
        level3[8][18] = new Cell(new Floor(),null,fireTrap1);//new Diamond()
        ...
        level3[9][28] = new Cell(new Floor(),new Chest(null, null, null, null, null),null);
        ...
        level3[12][16] = new Cell(new Floor(),null,null);
        ...
        level3[12][21] = new Cell(new Floor(),null,fireTrap2);
        ...
        level3[13][21] = new Cell(new Floor(),null,fireTrap2);
        level3[13][22] = new Cell(new Floor(),null,null);
        level3[13][23] = new Cell(new Floor(), new Chest(null, null, new SilverKey(), null, null),null);
        level3[13][25] = new Cell(new Floor(),null,null);
        level3[13][27] = new Cell(new Floor(),new Chest(null, null, null, null, null),null);
        ...
        level3[14][15] = new Cell(new Floor(),null,null);
        ...
        level3[14][21] = new Cell(new Floor(),null,fireTrap2);
        ...
        level3[15][21] = new Cell(new Floor(),null,fireTrap2);//head
        ...
        level3[17][19] = new Cell(new Floor(),new Chest(null, null, null, null, null),null);
        level3[17][21] = new Cell(new Floor(),null,null);
        level3[17][26] = new Cell(new Floor(),null,null);
        level3[17][27] = new Cell(new Floor(),null,null);
        /*level3[16][1] = new Cell(new Floor(),null,null);
        level3[16][1] = new Cell(new Floor(),null,null);
        level3[16][1] = new Cell(new Floor(),null,null);
        level3[16][1] = new Cell(new Floor(),null,null);
        level3[16][1] = new Cell(new Floor(),null,null);
        ...
        /*level3[5][20] = new Cell(pressMechanism.pressPanel,null,null);
        level3[13][13] = new Cell(doubleDoor.leftDoor,null,null);
        level3[14][18] = new Cell(pressMechanism2.door,null,null);
        level3[19][9] = new Cell(new Floor(),null,fireTrap3);
        level3[20][13] = new Cell(doubleDoor.rightDoor,null,null);
        level3[21][5] = new Cell(new Floor(),new Tumbleweed(),null);
        level3[21][6] = new Cell(new Floor(),new Tumbleweed(),null);
        level3[21][18] = new Cell(new BlockedDoor(),null,null);
        level3[27][5] = new Cell(new Floor(),null,new Rock());
        level3[30][18] = new Cell(new DoorWithKeyhole().silver,null,null);
        level3[32][14] = new Cell(new Floor(),new Diamond(),null);
        level3[36][4] = new Cell(new DiamondDoor(10,true),null,null);
        level3[36][11] = new Cell(new Floor(),null,scorpion);
        level3[38][14] = new Cell(new Floor(),new Chest(null, null, null, null, null),null);*/
